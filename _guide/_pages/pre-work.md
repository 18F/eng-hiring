...
**Option 1**: Submit a code sample you've written elsewhere to share with us and discuss. This could be something you've done at a previous job, for an outside project, or even something you did for fun like an [Advent of Code](https://adventofcode.com/) puzzle. This is subject to a few conditions:
